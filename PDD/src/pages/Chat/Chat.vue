  ...
  <div class="chat">
    <div v-if="userInfo.id">
      ...
      <main class="jd_shopCart_list">
        <section>
          <div class="shopCart_list_con"  v-for="(goods,index) in userCart" :key="index" >
            <div class="list_con_left">
              <a 
              href="javascript:;" 
              class="cart_check_box" 
              :checked='goods.checked'
              @click.stop="singleSelect(goods)"
              ></a>
            </div>
            <div class="list_con_right">
              ...
              <div class="shop_con">
                ...
                <div class="shop_deal">
                  ...
                  <div class="shop_deal_right" @click.stop="clickDelete(goods)">
                    <span></span>
                    <span></span>
                  </div>
                </div>
...
<script>
  ...
  export default {
    ...
    data(){
      return{
        isSelectedAll:false, //选中所有商品
        totalPrice:0,
      }
    },
    computed: {
      ...mapState(['userInfo','userCart']),
    },
    components: {
      SelectLogin,
      Shop,
    ...
    mounted() {
      // 请求商品数据
      this.$store.dispatch('reqQueryShopCart');
    },
    methods: {
      // 1. 单个商品的增加和减少
      ...
      hasSelectAll(){
        let flag = true;
        this.userCart.forEach((goods,index)=>{
          if(!goods.checked){
            flag=false;
          }
        })
